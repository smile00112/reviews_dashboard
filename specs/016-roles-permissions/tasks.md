...
- [X] T031 Run the quickstart.md validation end-to-end: `pytest -v` (api) then `npm run lint && npm run test:e2e` (web); fix any gaps. Confirm the catalog exposes no reply permission and the sqladmin panel admits only admin-slug users.
